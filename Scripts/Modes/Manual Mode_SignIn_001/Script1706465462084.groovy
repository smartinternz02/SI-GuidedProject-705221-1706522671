...
WebUI.setText(findTestObject('Object Repository/Amazon_Pages_SignIn_OR/Page_Amazon Sign-In/input_email'), 'durgeshkumar778080@gmail.com')

WebUI.click(findTestObject('Object Repository/Amazon_Pages_SignIn_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Pages_SignIn_OR/Page_Amazon Sign-In/input_password'), 'wyzziq9mVWQjeLthOCNz3A==')
